...
var TableOfContentsTooltip = {
    ...
    show: function() {
        ...
        if(TableOfContentsTooltip.target.offsetWidth > 200) {
            pos_left = 0;
        }else if((TableOfContentsTooltip.target.offsetLeft + ( TableOfContentsTooltip.target.offsetWidth / 2 )) > 
		(TableOfContentsTooltip.tooltip.offsetWidth / 2) && (250 - TableOfContentsTooltip.target.offsetLeft + 
		( TableOfContentsTooltip.target.offsetWidth / 2 )) > (TableOfContentsTooltip.tooltip.offsetWidth / 2)){
            pos_left = TableOfContentsTooltip.target.offsetLeft + ( TableOfContentsTooltip.target.offsetWidth / 2 ) - 
			( TableOfContentsTooltip.tooltip.offsetWidth / 2 );
        }
